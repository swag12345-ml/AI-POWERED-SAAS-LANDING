...
<div style='display:flex;justify-content:space-between;align-items:center;padding:16px 24px;max-width:1200px;margin:0 auto;'>
  ...
  <div style='display:flex;gap:32px;align-items:center'>
    ...
    <a href="https://hirelyzer-gw3qxm37vyfpcvcbstyb6p.streamlit.app/" target="_blank" class='btn' style='text-decoration:none'>
      🚀 Open App
    </a>
  </div>
</div>
...
<div class='hero'>
  <div class='hero-left'>
    ...
    <div class='cta-row'>
      <a href="https://hirelyzer-gw3qxm37vyfpcvcbstyb6p.streamlit.app/" target="_blank" class='btn'>
        ✨ Launch App
      </a>
  ...
  <div style='max-width:700px;margin:0 auto;text-align:center'>
    ...
    <div style='display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:24px;margin-bottom:40px'>
      ...
      <div class='feature-card' style='text-align:center;padding:24px'>
        ...
        <a href='https://hirelyzer-gw3qxm37vyfpcvcbstyb6p.streamlit.app/' target='_blank' style='color:#8ab4f8;text-decoration:none;font-weight:600'>https://hirelyzer-ijkfwqydjqz3wqyvjkhegw.streamlit.app/</a>
      </div>
    </div>
